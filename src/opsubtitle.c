...
void sub_80C488C(int bg)
{
    ...
    Decompress(Img_CommGameBgScreen, (void *)(BG_CHR_ADDR(0x0) + offset));
    CpuFastFill(0, (void *)(BG_CHR_ADDR(0x280) + offset), CHR_SIZE);
...
void OpSubtitle_Init(struct OpSubtitleProc * proc)
{
    ...
    Decompress(Img_08B17B64, (void *)(BG_CHR_ADDR(0x0) + GetBackgroundTileDataOffset(BG_2)));
    ApplyPalettes(Pal_08B18ED4, 0, 3);

    BG_Fill(gBG2TilemapBuffer, 0);
    BG_EnableSyncByMask(BG2_SYNC_BIT);

    StartBgm(SONG_BGM_PRO_FIRST, NULL);
